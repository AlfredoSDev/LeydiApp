...
public class RegistrarProducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ENTRADA_NOMBRE.setBorder(null);
        getContentPane().add(ENTRADA_NOMBRE, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 11, 343, 20));
        ...
        ENTRADA_CANTIDAD.setBorder(null);
        getContentPane().add(ENTRADA_CANTIDAD, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 49, 343, 20));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Cantidad:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 60, 20));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 80, 20));

        ENTRADA_PRECIO.setBorder(null);
        getContentPane().add(ENTRADA_PRECIO, new org.netbeans.lib.awtextra.AbsoluteConstraints(61, 87, 343, 20));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 410, 150));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            int bandera = 0;
            String nombre = ENTRADA_NOMBRE.getText().toUpperCase().trim();
            String cantidad = ENTRADA_CANTIDAD.getText().trim();
            String precio = ENTRADA_PRECIO.getText().toUpperCase().trim();
